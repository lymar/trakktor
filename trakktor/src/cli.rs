...
/// gaps a dropped packet leaves in a call), reading the text off a scan or a
/// screenshot page by page, marking a page up into labelled blocks (title,
/// heading, paragraph, footnote, table, formula, picture), restoring
